...
/* WEBPACK VAR INJECTION */(function($) {console.log('admin.js dispatched');

$().ready(function () {
    $('.toast-message').each(function (i, e) {
        window.sMessage.show($(e).attr('data-title'), $(e).attr('data-text'), $(e).attr('data-type'), $(e).attr('data-duration'));
    });
});
...
window.hashtag = {
    ...
    create: function create(el) {
        ...
        $.ajax({
            ...
            success: function success(data) {
                if (data.status) {
                    window.sMessage.show('Hashtag created', 'Hashtag #' + data.id, 'primary', 15000);
...
window.challenge = {
    ...
    toggle: function toggle(el) {
        ...
        $.ajax({
            ...
            success: function success(data) {
                if (data.status) {
                    window.sMessage.show('Yes!', 'Status toggled', 'primary', 3000);
                } else {
                    window.sMessage.show('Ouch!', 'Error toggling status', 'error', 3000);
                }
        ...
        $.ajax({
            ...
            success: function success(data) {
                ...
                if (data.status) {
                    ...
                    window.sMessage.show('Done!', 'Object associated', 'primary', 15000);
                } else {
                    window.sMessage.show('ow!', 'Error associating object :(', 'primary', 15000);
                }
...
window.place = {
    working: false,
    createSpot: function createSpot(el) {
        if (this.working) return;
        ...
        $.ajax({
            ...
            success: function success(data) {
                ...
                if (data.status) {
                    window.sMessage.show('Done!', 'Spot create', 'primary', 15000);
                } else {
                    window.sMessage.show('ow!', 'Error creating spot :(', 'primary', 15000);
                }
