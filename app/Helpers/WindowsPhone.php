...
class WindowsPhone
{
     ...
     */
    public function push_toast($id,$a,$title, $subtitle,$delay = WindowsPhonePushDelay::Immediate, $message_id=NULL)
    {
        ...
        elseif($a == "Photo"){
            $msg =	"<?xml version=\"1.0\" encoding=\"utf-8\"?>" .
                ...
                "<wp:Text1>".htmlspecialchars($title)."</wp:Text1>" .
                "<wp:Text2>".htmlspecialchars($subtitle)."</wp:Text2>" .
                "<wp:Param>/Templates/PhotoView.xaml?photo_id=".$id."</wp:Param>" .
                "</wp:Toast>" .
                "</wp:Notification>";
        }
        elseif($a == "Me"){
            $msg =	"<?xml version=\"1.0\" encoding=\"utf-8\"?>" .
                ...
                "<wp:Text1>".htmlspecialchars($title)."</wp:Text1>" .
                "<wp:Text2>".htmlspecialchars($subtitle)."</wp:Text2>" .
                "<wp:Param>/Templates/Conversacion.xaml?id=".$id."</wp:Param>" .
                "</wp:Toast>" .
                "</wp:Notification>";
        }
        else{
    ...
    public function push_tileClear($background_url, $title, $count, $delay = WindowsPhonePushDelay::Immediate,$message_id=NULL)
    {
        $msg = 	"<?xml version=\"1.0\" encoding=\"utf-8\"?>" .
            "<wp:Notification xmlns:wp=\"WPNotification\">" .
            "<wp:Tile>" .
